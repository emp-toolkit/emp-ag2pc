...
//
// C2PC is pure crypto: input authentication (process_inputs) and output decode
...
// agc.tex — lives in the one protocol executor, LambdaRunner::run_engine_
// (lambda_runner.h), which replays a circuit SOURCE (a pure frontend body, a
